...
\begin{titlepage}
	...
	\begin{minipage}{0.85\textwidth}
		\noindent
		\begin{tabular}{!{\color{coverblue}\vrule width 5pt} p{\dimexpr\textwidth-25pt}}
			\colorbox{coverblue!10}{
				\begin{minipage}[t]{\dimexpr\textwidth-25pt}
					\centering
					
					\vspace{18pt}
					
					{\Large\bfseries\color{covergray}
						เอกสารประกอบการสอนคณิตศาสตร์}\\[1.0em]
					
					{\Huge\bfseries\color{covergray}
						รายวิชาเพิ่มเติม ม.4 เล่ม 1}\\[1.2em]
...
เอกสารประกอบการสอนคณิตศาสตร์ รายวิชาเพิ่มเติม รหัสวิชา ค31201 ชั้นมัธยมศึกษาปีที่ 4 เรื่อง \textquotedblleft จำนวนจริง\textquotedblright\ ฉบับนี้ จัดทำขึ้นเพื่อใช้เป็นสื่อประกอบการจัดกิจกรรมการเรียนรู้ในชั้นเรียน โดยมีวัตถุประสงค์เพื่อส่งเสริมความรู้ ความเข้าใจ และทักษะกระบวนการทางคณิตศาสตร์ของนักเรียน ตลอดจนสนับสนุนการจัดการเรียนการสอนให้เป็นไปอย่างมีประสิทธิภาพ

เอกสารฉบับนี้จัดทำและออกแบบด้วยโปรแกรม \LaTeX{} โดยยึดเนื้อหาหลักจากหนังสือเรียนรายวิชาเพิ่มเติมคณิตศาสตร์ ชั้นมัธยมศึกษาปีที่ 4 ของสถาบันส่งเสริมการสอนวิทยาศาสตร์และเทคโนโลยี (สสวท.) และปรับรูปแบบการนำเสนอให้เหมาะสมกับบริบทการจัดการเรียนการสอนของผู้จัดทำ ทั้งในด้านการจัดลำดับเนื้อหา การเว้นพื้นที่สำหรับบันทึกสาระสำคัญ การแสดงวิธีทำตัวอย่าง และการทำกิจกรรมการเรียนรู้ในชั้นเรียน

ผู้จัดทำขอขอบพระคุณสถาบันส่งเสริมการสอนวิทยาศาสตร์และเทคโนโลยี (สสวท.) ซึ่งเป็นแหล่งที่มาหลักของเนื้อหา ตัวอย่าง และกิจกรรมการเรียนรู้ที่ใช้ในการเรียบเรียงเอกสารฉบับนี้ และหวังเป็นอย่างยิ่งว่าเอกสารประกอบการสอนฉบับนี้จะเป็นประโยชน์ต่อการเรียนรู้ของนักเรียน ช่วยส่งเสริมความเข้าใจในเรื่องจำนวนจริง และเป็นพื้นฐานสำคัญสำหรับการศึกษาคณิตศาสตร์ในระดับที่สูงขึ้นต่อไป
