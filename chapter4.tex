...
\begin{examplebox} \label{example1.10}
...
\begin{examplebox}\label{example1.11}
...
\newpage
\begin{examplebox}\label{example1.17}
...
\newpage
\section{ทฤษฎีบทของเมเนลอส}
\begin{theorembox}[ทฤษฎีบทของเมเนลอส (กรณีตัดผ่านด้าน)]
	ถ้าจุด $N, M$ และ $L$ อยู่บนด้านหรือส่วนที่ต่อออกไปตามลำดับของด้าน $BC, CA$ และ $AB$ ของรูปสามเหลี่ยม $ABC$ และจุดทั้งสามอยู่บนเส้นตรงเดียวกัน ดังรูป~\ref{Figure72} แล้ว
	\[
	\frac{AM}{MC} \cdot \frac{CN}{NB} \cdot \frac{BL}{LA} = 1
	\]
\end{theorembox}
...
\begin{figure}[H]
	...
	\caption{ทฤษฎีบทของเมเนลอสในกรณีที่เส้นตรงตัดผ่านด้านของรูปสามเหลี่ยม}
	\label{Figure72}
\end{figure}

\newpage
\begin{theorembox}[ทฤษฎีบทของเมเนลอส (กรณีตัดผ่านส่วนต่อขยาย)]
	ถ้าจุด $L, M$ และ $N$ อยู่บนส่วนที่ต่อออกไปตามลำดับของด้าน $BC, CA$ และ $AB$ ของรูปสามเหลี่ยม $ABC$ และจุดทั้งสามอยู่บนเส้นตรงเดียวกัน ดังรูป~\ref{Figure73} แล้ว
	\[
...
\begin{figure}[H]
	...
	\caption{ทฤษฎีบทของเมเนลอสในกรณีที่เส้นตรงตัดผ่านส่วนต่อขยายของรูปสามเหลี่ยม}
	\label{Figure73}
\end{figure}
